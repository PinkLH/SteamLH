(function(e, t) {
    ...
    var n = function() {
        ...
        this.setup = function() {
            this.el.css({ width: n.max[0], height: this.items.first().outerHeight() });
        ...
        this.move = function(t, r) {
            ...
            if (!this.ul.is(":animated")) {
                n.el.find(".dot:eq(" + t + ")").addClass("activethumb").siblings().removeClass("activethumb");
        ...
        this.dots = function() {
            var t = '<ol class="dots">';
            e.each(this.items, function(e) { t += '<li class="dot' + (e < 1 ? " activethumb" : "") + '"></li>' });
            t += "</ol>";
